...
const s_formId = '1FAIpQLScMMLrR6Re9PPED1hhZr8xqjN0aJLPax4VcnBQy9D4XykcLMA'; // The Google Form
const s_nameId = '1145506207'; // The Name field ID
const s_websiteId = '1308149306'; // The Website field ID
const s_textId = '1933146163'; // The Text field ID
const s_pageId = '1815030241'; // The Page field ID
const s_replyId = '1329281097'; // The Reply field ID
const s_sheetId = '1DtLTlRqIKZTBW-ecaJthC539gM4n_aM_8EuzLavgnXA'; // The Google Sheet

// Misc - Other random settings
const s_commentsPerPage = 100; // The max amount of comments that can be displayed on one page, any number >= 1 (Replies not counted)
